...
abstract public class GraphView extends LinearLayout {
	...
	private GraphViewContentView content;
	...
	public GraphView(Context context, AttributeSet st) {
		super(context, st);
		setLayoutParams(new LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT));

		this.title = "Mic Amlpitude";
		...
		viewVerLabels = new VerLabelsView(context);
		addView(viewVerLabels);
		content = new GraphViewContentView(context);
		addView(content, new LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT, 1));
	}
