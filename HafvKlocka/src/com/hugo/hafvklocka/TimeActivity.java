...
public class TimeActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(Game.getGameMode() == Konstants.TIME_MODE){
            clock = new Clock(time1);
        }else{
            clock = new Clock(time1, time2, done);
    ...
    private void selectWinner(int t){
    	...
    	selectWinner.setButton(DialogInterface.BUTTON_POSITIVE, Game.getNextHeats().getPlayer1().getName(),new DialogInterface.OnClickListener() {
    		public void onClick(DialogInterface dialog, int which) {
    			reportWinner(Game.getNextHeats().getPlayer1(), Game.getNextHeats().getPlayer2());
    		}

    	});
    	selectWinner.setButton(DialogInterface.BUTTON_NEGATIVE, Game.getNextHeats().getPlayer2().getName(),new DialogInterface.OnClickListener() {
    		public void onClick(DialogInterface dialog, int which) {
